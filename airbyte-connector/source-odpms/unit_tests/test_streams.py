...
import pytest
from source_odpms.source import OdpmsStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(OdpmsStream, "path", "v0/example_endpoint")
    mocker.patch.object(OdpmsStream, "primary_key", "test_primary_key")
    mocker.patch.object(OdpmsStream, "__abstractmethods__", set())
